    ...
    $.fn.wc_variation_form = function () {
        ...
        $form = this
                ...
                .on('found_variation', function (event, variation) {
                     ...
                     */
                    var indexOfThumb = $(".woocommerce div.product div.images div.thumbnails a[title='"+variation.image_title+"']").index();
                    $(".woocommerce div.product div.images div.thumbnails a[title='"+variation.image_title+"']").click();
                    $('.woocommerce div.product div.images div.thumbnails').slick('slickGoTo',indexOfThumb);
